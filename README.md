# Password-Generator
The random password generator application generates a set of random password for users based upon the user input. Once the user clicks on Generate Password button, the user will be asked a series of questions, and finally the user will be given a set of password based on the questions they have answered. 
